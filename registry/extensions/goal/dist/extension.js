"use strict";
let state = { objective: "", active: false, paused: false };
...
tokio.defineExtension({
    ...
    onCommand(_handler, commandInput) {
        ...
        return [
            tokio.actions.submitPrompt(`Work autonomously toward this goal:\n\n${input}\n\nContinue until verified complete or genuinely blocked.`, true),
