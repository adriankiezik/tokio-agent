...
“Allow for session” stores only a canonical narrow operation scope. Bash approvals match the exact command and working directory, and edit approvals match their target path. They reset with the session.
